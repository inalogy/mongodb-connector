...
public class MongoDbConfiguration extends AbstractConfiguration {
    ...
    private String liveSyncAttributeName;
    ...
    @ConfigurationProperty(order = 29, displayMessageKey = "liveSyncAttributeName.display", helpMessageKey = "liveSyncAttributeName.help")
    public String getLiveSyncAttributeName() {
        return liveSyncAttributeName;
    }
    ...
    public void setLiveSyncAttributeName(String setLiveSyncAttributeName) { this.liveSyncAttributeName = setLiveSyncAttributeName; }
    @Override
